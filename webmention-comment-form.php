<div class="comment-respond">
	...
	<p class="text-muted">
		<small><?php echo esc_html( get_webmention_form_text( get_the_ID() ) ); ?></small>
	</p>
	<form id="webmention-form" class="form-inline" action="<?php echo esc_attr( get_webmention_endpoint() ); ?>" method="post">
